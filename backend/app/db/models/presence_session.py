...
class PresenceSession(Base):
    ...
    status: Mapped[str] = mapped_column(String(30), default='VISIBLE', nullable=False, index=True)
    duration_seconds: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    activity_segments: Mapped[List[ActivitySegment]] = relationship('ActivitySegment', back_populates='session', cascade='all, delete-orphan')
